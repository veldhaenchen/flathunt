...
class Env:
    ...
    # Captcha setup
    FLATHUNTER_2CAPTCHA_KEY = __readenv("FLATHUNTER_2CAPTCHA_KEY")
    FLATHUNTER_IMAGETYPERZ_TOKEN = __readenv("FLATHUNTER_IMAGETYPERZ_TOKEN")
    FLATHUNTER_HEADLESS_BROWSER = __readenv("FLATHUNTER_HEADLESS_BROWSER")

    # Generic Config
    FLATHUNTER_TARGET_URLS = __readenv("FLATHUNTER_TARGET_URLS")
    FLATHUNTER_DATABASE_LOCATION = __readenv("FLATHUNTER_DATABASE_LOCATION")
    FLATHUNTER_GOOGLE_CLOUD_PROJECT_ID = __readenv("FLATHUNTER_GOOGLE_CLOUD_PROJECT_ID")
    FLATHUNTER_VERBOSE_LOG = __readenv("FLATHUNTER_VERBOSE_LOG")
    FLATHUNTER_LOOP_PERIOD_SECONDS = __readenv("FLATHUNTER_LOOP_PERIOD_SECONDS")
    FLATHUNTER_MESSAGE_FORMAT = __readenv("FLATHUNTER_MESSAGE_FORMAT")

    # Website setup
    FLATHUNTER_WEBSITE_SESSION_KEY = __readenv("FLATHUNTER_WEBSITE_SESSION_KEY")
    FLATHUNTER_WEBSITE_DOMAIN = __readenv("FLATHUNTER_WEBSITE_DOMAIN")
    FLATHUNTER_WEBSITE_BOT_NAME = __readenv("FLATHUNTER_WEBSITE_BOT_NAME")
