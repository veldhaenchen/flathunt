...
class ChromeWrapperTest(unittest.TestCase):
    ...
    def test_parse_chrome_version(self, subprocess_mock):
        subprocess_mock.side_effect = [ None, None, None, None, 'Chromium 107.0.5304.87 built on Debian bookworm/sid, running on Debian bookworm/sid', 'Google Chrome 107.0.5304.110' ]
