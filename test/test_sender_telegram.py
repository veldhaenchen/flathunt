...
class SenderTelegramTest(unittest.TestCase):
    ...
    def setUp(self):
      self.sender = SenderTelegram({ "telegram": { "bot_token": "dummy_token", "receiver_ids": [ 123 ] }})
    ...
    def test_send_message(self, m):
      ...
      self.assertEqual(None, self.sender.send_msg("result"), "Expected message to be sent")
